...
if (isset($_GET['up_id'])) {
    ...
    die("Invalid Request: Music ID not provided.");
}
...
if (isset($_POST['update'])) {
    ...
    if (mysqli_query($connect, $updateQuery)) {
        echo "<script>alert('Music Updated Successfully'); window.location.href='showmusic.php';</script>";
    } else {
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="gradient-border" style="width: 520px;">
        ...
        <h3 class="text-center mb-4">Update Music</h3>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center">
                <button type="submit" name="update" class="btn btn-primary w-100">Update Music</button>
            </div>
        </form>
    </div>
</div>
